...
SOLID原则是由美国软件工程师Robert C. Martin（也被称为Bob大叔）提出的，所谓SOLID原则，即
...
- 
这些原则被广泛应用于面向对象设计和软件开发中，以提高代码的可维护性、可扩展性和可重用性。它们强调了良好的设计原则和实践，有助于构建高质量的软件系统。

单一职责是一个听起来好像很明白，实际使用时却是十分不好掌握的一个原则，先看下Bob大叔对于单一职责的定义：
